<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="属性命名： 颜色 大小 尺码 型号" prop="attributeName">
        <el-input
          v-model="queryParams.attributeName"
          placeholder="请输入属性命名： 颜色 大小 尺码 型号"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="attributeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商品属性ID" align="center" prop="id" />
      <el-table-column label="属性描述：JSON" align="center" prop="attributeDescribed" />
      <el-table-column label="商品ID" align="center" prop="productId" />
      <el-table-column label="属性命名： 颜色 大小 尺码 型号" align="center" prop="attributeName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="属性命名： 颜色 大小 尺码 型号" prop="attributeName">
          <el-input v-model="form.attributeName" placeholder="请输入属性命名： 颜色 大小 尺码 型号" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除商品属性表编号为"' + ids + '"的数据项？').then(function() {
